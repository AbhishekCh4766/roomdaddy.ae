					...
					<div style="overflow:auto;">
						<table id="myTable" class="table table-striped table-bordered">
							<thead>
								...
								<th>Expected Rent</th>
								<th>Owner</th>
								<?php if(in_array('8',$arr) || in_array('4',$arr)){ ?>
								<th>Book</th>
							<?php } ?>
							</thead>
							<tbody>
								<?php
									if($GetVacant[0]!="")
									{
										...
										foreach($GetVacant as $rooms)
										{
											...
											<tr>
												<td><?=$i?></td>
												<td><a href="room_gallery.php?rid=<?=base64_encode($rooms['room_id'])?>"><?=$rooms['area']?></a></td>
												...
												<td>
												<?php
												 $checkbedspace=$db->checkbedspaceorRoom($rooms['bedspace']);
													//$i=0;
												// echo count($checkbedspace);
													if(count($checkbedspace)==1)
													{
														echo "Room";
													}
													else
												...
												<td>
													<?php
														if(!empty($rooms['bedspace_expected_rent']))
														{
															echo $rooms['bedspace_expected_rent'];
														}
														else
														{
															echo $rooms['room_expected_rent'];
														}
													?>
												</td>
												<td>
												...
												<td>
													...
													if($rooms['approved']=='1'){
														?>
													<a href="register_client.php?bedspace=<?=base64_encode($rooms['bedspace_id'])?>">Book</a>
													<?php
												}
                                                   else
                                                   {
