              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<label>Select Month
					<select name="datatablde_length" aria-controls="datatable" class="form-control input-sm" onchange="recieved_summary(this.value,<?=$_SESSION[ADMIN_SESSION_NAME]['userid']?>); recievable_summary(this.value,<?=$_SESSION[ADMIN_SESSION_NAME]['userid']?>);">
