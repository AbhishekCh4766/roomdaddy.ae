          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
				...
				$getName=$am->getAdminName($id);
				echo $getName[0]['fld_name'];
				?>  <small>Rent Collection</small></h3>
              </div>
            </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						if($_SESSION[ADMIN_SESSION_NAME]['userid']!="69")
						{
						$getBuilding=$db->getAllBuildings($id);
						if($getBuilding[0]!="")
						{	
						...
						{
							?>
							<option value="14">Princess Tower 1306</option>
							<?php
						}
					?>
					</select> 
