...
{
	$error_msg.='<div id="fail" class="info_div"><span class="ico_cancel" id="error_msg">Please Select Assign To</span></div>';
}
...
if($error_msg=="")
{
	$flag = $db->AddExpense(
							...
							SG_Validate_Input($_REQUEST['assign_to'],INPUT_TYPE_TEXT)
							);
							if(count($flag) > 0)
							{	
