	...
	foreach($fleets as $room)
	{
		...
		<tr>
			<td>
				...
				{
					echo "<a href='".SERVER_PATH."edit_room.php?rid=".base64_encode($room['fld_id'])."'>".$room['fld_room_name']."</a>";
				}
				else
				{
					echo "<a href='".SERVER_PATH."edit_room.php?rid=".base64_encode($room['fld_id'])."'>".$room['fld_custom_room_name']."</a>";
				}?>
			</td>
			<td>
				<?php
...
<?php
	...
	?>
	<tr>
			<td colspan="4">Rental Income of Current Month</td>
			<td><?=$rent_in?></td>
	</tr>
	<tr>
			<td colspan="4">Deposit In of Current Month</td>
			<td>
			<?php
			echo $Deposit_in;
			?>
	...
	<tr>
			<td colspan="4">Deposit Out of Current Month</td>
			<td>
			<?php
			echo $Deposit_out;
			?>
	...
	<tr>
			<td colspan="4">Expense of Current Month</td>
			<td>
			<?php
			echo $expense;
			?>
